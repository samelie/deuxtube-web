...
module.exports = (auth, send) => {
  ...
  const onload = (el)=>{
      ...
      return html`
        ...
        <p>Now we have these enormous databases of video and our own caches of personal knowledge that grants us access into these realms. No algorithm can mimic the leaps and recalls we get when chaining together thoughts, certainly not our curiosity and ingenuity when it comes to combination.</p>
